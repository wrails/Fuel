...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { latitude: @office.latitude, longitude: @office.longitude, name: @office.name, postcode: @office.postcode, user_id: @office.user_id } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { latitude: @office.latitude, longitude: @office.longitude, name: @office.name, postcode: @office.postcode, user_id: @office.user_id } }
